const CACHE='piano-hotel-v1';
const URLS=['/hotel/mobile-hotel-panel.html','/assets/piano-theme.css','/assets/common.js','/assets/firebase-api.js','/config/config.js','/config/firebase.js'];
