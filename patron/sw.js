const CACHE = 'piano-patron-v1';
const URLS = ['/patron/index.html','/assets/piano-theme.css','/assets/common.js','/assets/firebase-api.js','/config/config.js','/config/firebase.js'];
